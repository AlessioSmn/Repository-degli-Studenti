...
/**
 * Funzione di utlità per processare query / DML statements. Richiede che sia stato precedentemente incluso un file con le variabili di configurazione per la connessione al database
 ...
 */
function executePreparedStatement($sqlStatement, &$affectedRows, $parameterTypes = null, $parameterValue = null){
